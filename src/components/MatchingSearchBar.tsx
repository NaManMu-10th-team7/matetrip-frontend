        ...
        <form onSubmit={handleSubmit} className="flex-1 relative">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-blue-200 focus:ring-blue-500 h-auto text-base"
            />
          </div>
        </form>
        <div className="relative">
          <Button
            ...
            className={`gap-2 px-6 py-3 h-auto border-gray-200 text-lg ${
          ...
          {isFilterOpen && (
            <div className="absolute right-0 mt-2 w-[450px] rounded-2xl border border-gray-200 bg-white shadow-xl p-5 z-50 space-y-5">
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <input
                    ...
                    className="w-full rounded-lg border border-gray-200 px-3 py-2 text-base focus:border-blue-500 focus:ring-blue-200"
                  />
                  <input
                    type="date"
                    value={endDate}
